...
const Services = () => {
  return (
    <div className='grid' id='services'>
        ...
        <section id='#services' className='bg-gradient-to-t from-blue-900 to-indigo-300 w-full min-h-[60vh] pt-[-50px] flex items-center justify-center pl-[2rem] pb-[5rem] custom_responsive' >
            {/* Services card design */}
            {exploreServices.map((service, index) => (
                <div data-aos="flip-right" data-aos-duration="800" key={service.id} className='flex w-[200px] h-[280px] flex-col mx-2 p-10 rounded-md bg-white gap-5 hover_effect'>
