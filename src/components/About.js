...
const About = () => {
  return (
    <div id='#about' className='flex flex-row px-5 py-8 bg-red-400 custom_bg'>
        <div className='flex items-center justify-center mx-auto'>
            <div className='p-5 px-8 py-8'>
                <h1 className='text-white text-[26px] text-left mb-5 underline underline-offset-[5px] custom_align_2'> About </h1>
